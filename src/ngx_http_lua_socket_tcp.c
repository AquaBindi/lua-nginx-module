...
ngx_http_lua_inject_socket_tcp_api(ngx_log_t *log, lua_State *L)
{
    ...
    ngx_http_lua_push_47bit_lightud(L, &ngx_http_lua_raw_req_socket_metatable_key);
    ...
    ngx_http_lua_push_47bit_lightud(L, &ngx_http_lua_upstream_udata_metatable_key);
    ...
    ngx_http_lua_push_47bit_lightud(L, &ngx_http_lua_downstream_udata_metatable_key);
    lua_createtable(L, 0 /* narr */, 1 /* nrec */); /* metatable */
    ...
    ngx_http_lua_push_47bit_lightud(L, &ngx_http_lua_pattern_udata_metatable_key);
    lua_createtable(L, 0 /* narr */, 1 /* nrec */); /* metatable */
